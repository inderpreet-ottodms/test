...
export const environment = {
    ...
    environmentName:"QA",
    production: false,
    APIEndPoint: 'https://qaappapi.mfg.com/api/',
    HubEndPoint: 'https://qaappapi.mfg.com/',
    AppUrl: 'https://qaapp.mfg.com/',
    SSOUrl: 'https://qa.mfg.com/sso/index.php',
    RedirectionToCommunityPages: 'https://qa.mfg.com/',
    RegistrationLink: 'https://qa.mfg.com/registration/',
    RedirectToMaterialPage: 'https://qamaterials.mfg.com/sso/index.php',
    stripePk: 'pk_test_51LONVIGWEpBLxDePtxLdQhseTkUDCUraiqwfqwv0CIYDyh0B4HwWXsKmISdEGMpnsVkdVdxiGcJbgRNI6aPBgw8d002YY8F0AD',
    RedirectToCommunityQuote: 'https://qa.mfg.com/materials-quote-request/',
