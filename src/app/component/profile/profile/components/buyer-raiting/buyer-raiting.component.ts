...
@Component({
  selector: 'app-buyer-raiting',
  templateUrl: './buyer-raiting.component.html',
  styleUrls: ['./buyer-raiting.component.scss']
})
export class BuyerRaitingComponent implements OnInit {
  ...
  formatDate(stringDate: string) {
    ...
    return '' + (1 + itemDate.getMonth()) + '/' + itemDate.getDate() + '/' + itemDate.getFullYear();
  }
