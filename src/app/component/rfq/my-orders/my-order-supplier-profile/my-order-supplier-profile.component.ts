...
@Component({
  selector: 'app-my-order-supplier-profile',
  templateUrl: './my-order-supplier-profile.component.html',
  styleUrls: ['./my-order-supplier-profile.component.scss',
    '../../../../../assets/icon/icofont/css/icofont.scss'
  ]
})
export class myOrderSupplierProfileComponent implements OnInit, OnDestroy {
