...
import { ICertificationViewModel, IAboutUsViewModel } from '../../../../../core/models/supplierProfileModel';
import { SupplierTypeViewModel } from '../../../../../core/models/globalMaster';
...
import { ISupplierDetailsViewModel, LikeUnlikeManufacturerRequestModel } from '../../../../../core/models/supplierModel';
...
export class QuoteSupplierProfileComponent implements OnInit, OnDestroy {
  ...
  getProfileDetails() {
    ...
    //     console.log('companyname' , this.iContactViewModel.company.name.replace('&' , '$'));
    //     const pattern = '&' ;
    // const data = pattern.match(this.iContactViewModel.company.name);
  ...
  // }
    ...
    this._SupplierService.getAboutUsDetails(companyId, this.iContactViewModel.contactId, true, this.loggedId).subscribe(
