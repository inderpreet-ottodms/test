...
@Component({
  selector: 'app-followedbuyer-rfq',
  templateUrl: './followedbuyer-rfq.component.html',
  styleUrls: ['./followedbuyer-rfq.component.scss']
})
export class FollowedbuyerRfqComponent implements OnInit {
  ...
  getRfqList() {
    ...
    this.isupplierRfqFilterViewModel.rfqType = 8;
