...
@Component({
  selector: 'app-liked-rfq',
  templateUrl: './liked-rfq.component.html',
  styleUrls: ['./liked-rfq.component.scss']
})
export class LikedRfqComponent implements OnInit {
  ...
  getRfqList() {
    ...
    this.isupplierRfqFilterViewModel.rfqType = 4;
