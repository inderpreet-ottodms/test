...
@Component({
  selector: 'app-my-awarded-rfq',
  templateUrl: './my-awarded-rfq.component.html',
  styleUrls: ['./my-awarded-rfq.component.scss']
})
export class MyAwardedRfqComponent implements OnInit {
  ...
  ngOnInit() {
    localStorage.setItem('pageName', "My Awarded RFQs");
    // this.getRfqList();
  ...
  // getRfqList() {
  //   this.isLoader = true;
  //   this._SupplierService.getSupplierRfq(this.loggedId, this.loggedCompanyId, 7).subscribe(
  //     result => {
