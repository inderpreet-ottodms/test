...
@Component({
  selector: 'app-quotes-in-progres',
  templateUrl: './quotes-in-progres.component.html',
  styleUrls: ['./quotes-in-progres.component.scss']
})
export class QuotesInProgresComponent implements OnInit {
  ...
  constructor(private _rfqService: RfqService, private _toastr: ToastrService,
    private router: Router, private _RfqService: RfqService,
  ...
  ngOnInit() {
    localStorage.setItem('pageName', "Quotes In-Progress RFQs");
    // this.getRfqList();
  ...
  // getRfqList() {
  //   this.isLoader = true;
  //   this._SupplierService.getSupplierRfq(this.loggedId, this.loggedCompanyId, 13).subscribe(
  //     result => {
