...
@Component({
  selector: 'app-special-invite-rfq',
  templateUrl: './special-invite-rfq.component.html',
  styleUrls: ['./special-invite-rfq.component.scss']
})
export class SpecialInviteRfqComponent implements OnInit {
  ...
  ngOnInit() {
    localStorage.setItem('pageName', "Special Invites RFQs");
    // this.getRfqList();
  ...
  // getRfqList() {
  //   this.isLoader = true;
  //   this._SupplierService.getSupplierRfq(this.loggedId, this.loggedCompanyId, 5).subscribe(
  //     result => {
